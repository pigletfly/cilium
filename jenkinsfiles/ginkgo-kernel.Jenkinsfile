            ...
            steps {
                ...
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:8dd18764353f75dc298b89430edc9bc0be85e3d6@sha256:5f758c9101c3ce28ad7ba00a1306e687c0ba543de8a1799e3309a28e9254aa20"
                    }
                }
            }
        }
